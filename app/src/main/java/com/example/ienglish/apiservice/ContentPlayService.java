 ...
 * 此服务为收藏文章播放服务
 */
public class ContentPlayService extends Service {
    public MediaPlayer mediaPlayer = null;
    private Timer timer = null;

    public ContentPlayService() {
    }
    ...
    private void addTimer(){
        ...
        TimerTask timerTask = new TimerTask() {
            ...
            public void run() {
                //每隔50毫秒执行一次
                Message msg = Play_Content.handler.obtainMessage();
                ...
                msg.setData(bundle);
                Play_Content.handler.sendMessage(msg);
            }
        };
