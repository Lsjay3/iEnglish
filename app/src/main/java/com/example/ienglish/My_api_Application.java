...
/**
 * 参考慕课老师:https://www.icourse163.org/learn/NNZY-1206134802?tid=1206448203#/learn/content?type=detail&id=1211662518&cid=1214478735
 */

public class My_api_Application extends Application {
    ...
    public static void initImageLoader(Context context) {
        ...
        mLoaderOptions = new DisplayImageOptions.Builder().
                showImageOnLoading(R.drawable.ic_launcher_background).//正加载，显示no_image
                showImageOnFail(R.drawable.ic_launcher_background).//加载失败时
                showImageForEmptyUri(R.drawable.ic_launcher_background).//加载的Uri为空
